...
<form action="b4pachieve.php" method="post" id="playerinfo">
	<table>
		<tr>
		...
		<tr>
			...
			<td><input type="submit" name="searchi" value="Search" class="btn"></td>	
 ...
 if (isset($_POST["searchi"]))
{
	...
	while ($row=mysqli_fetch_array($res_display))
	{
		...
		echo "<td>"; echo '<a href="pachieve.php?pid='.$row["pid"].' "><button class="btn">Record</button></a>';
; echo "</td>";
